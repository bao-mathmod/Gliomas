...
BASE_DIR="/mnt/18T/chibao/gliomas/data_official/00_raw_data_adult_GBM/1_raw_cell_ranger/cohort_official_GBM" # cohort_official or pbmc_post_treat or pbmc_healthy
OUT_DIR="/mnt/18T/chibao/gliomas/data_official/00_raw_data_adult_GBM/2_QC_output/pre_QC/official/cohort_official_GBM" # cohort_official or pbmc_post_treat or pbmc_healthy
