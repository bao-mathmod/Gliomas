...
# Load object
obj <- readRDS('/mnt/18T/chibao/gliomas/data/upstream/scRNA/official/integrated_v5_optimized/adult/cellchat/obj_cellchat_v2.rds')
obj
obj@meta.data |> head() 
...
# execution.time = Sys.time() - ptm
# print(as.numeric(execution.time, units = "secs"))
saveRDS(cellchat, "/mnt/18T/chibao/gliomas/data/upstream/scRNA/official/integrated_v5_optimized/adult/cellchat/obj_cellchat_done_official.rds")