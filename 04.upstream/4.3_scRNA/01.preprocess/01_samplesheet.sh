...
BASE_DIR="/mnt/18T/chibao/gliomas/data/output_cell/snRNA/official/dry_run"
OUT_DIR="/mnt/18T/chibao/gliomas/data/output_cell/snRNA/official/dry_run"
OUT_FILE="$OUT_DIR/snrna_official_manifest_dryrun.tsv"
