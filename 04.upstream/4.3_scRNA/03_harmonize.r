...
in_dir  <- "/mnt/18T/chibao/gliomas/data/upstream/scRNA/scRNA_clean_2/rds"
out_dir <- "/mnt/18T/chibao/gliomas/data/upstream/scRNA/scRNA_clean_2/rds_hgnc"; dir.create(out_dir, showWarnings=FALSE, recursive=TRUE)
...
in_dir  <- "/mnt/18T/chibao/gliomas/data/upstream/scRNA/scRNA_clean_2/rds"
out_dir <- "/mnt/18T/chibao/gliomas/data/upstream/scRNA/scRNA_clean_2/rds_hgnc_2"; dir.create(out_dir, showWarnings=FALSE, recursive=TRUE)
