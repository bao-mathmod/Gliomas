...
# ========================
BASE_DIR="/mnt/18T/chibao/gliomas/data/metadata/official/split5.2"   # Step-1 output root
OUTPUT_DIR="/mnt/18T/chibao/gliomas/data/fastq/ena/split5.2"         # where FASTQs are saved
