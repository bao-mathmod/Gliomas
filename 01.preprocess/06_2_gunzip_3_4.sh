...
process_one() {
  ...
  local DEST_BASE="/mnt/12T/chibao/data/official_data/fastq_by_tech/bulk_or_plate_RNA/official_cell/PRJNA961045/SAMN34341297/SRX20079432/SRR24283914"
  local DEST_DIR="${DEST_BASE}/${RUN}"
  mkdir -p "${DEST_DIR}"

  # R1
  pigz -p 1 "${SRC_DIR}/${RUN}_3.fastq"
  mv "${SRC_DIR}/${RUN}_3.fastq.gz" "${DEST_DIR}/${RUN}_S1_L001_R1_001.fastq.gz"

  # R2
  pigz -p 1 "${SRC_DIR}/${RUN}_4.fastq"
...
bash -lc 'process_one SRR24283914' &
wait
echo "All done."
