...
# ========================
BASE_DIR="/mnt/18T/chibao/gliomas/data/metadata/official/split4.1"   # Step-1 output root
OUTPUT_DIR="/mnt/18T/chibao/gliomas/data/fastq/ena/split4.1"         # where FASTQs are saved
