...
CSV_FILE="/mnt/18T/chibao/gliomas/data_official/00_raw_data_adult/0_fastq/0_metadata/glioma_accession.csv"
META_ROOT="/mnt/18T/chibao/gliomas/data_official/00_raw_data_adult/0_fastq/0_metadata/"
