...
# ========================
BASE_DIR="/mnt/18T/chibao/gliomas/data/metadata/official/split9"   # Step-1 output root
OUTPUT_DIR="/mnt/18T/chibao/gliomas/data/fastq/ena/split9"         # where FASTQs are saved
